...
/home/kiwoong/bioinformatics/plink/plink --file $file --make-bed --out $file --allow-no-sex --allow-extra-chr 0
/home/kiwoong/bioinformatics/plink/plink --bfile $file --freq --missing --within $2 --out $file --allow-no-sex --allow-extra-chr 0

# zip it
gzip $file".frq.strat"

# create input file for Treemix
python2 /home/kiwoong/Projects/sfrugi_invasive/TreeMIX/script/plink2treemix.py $file".frq.strat.gz" $file".treemix.frq.gz"
